...
const UpdateLoryDiba = () => {
    ...
    useEffect(() => {
        const fetchCurrentData = async () => {
            try {
                const res = await axios.get(`https://fatema-naz-server-7.onrender.com/lory-details-diba/${id}`);
                if (res.data) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.put(`https://fatema-naz-server-7.onrender.com/edit-lory-diba/${id}`, formData);
