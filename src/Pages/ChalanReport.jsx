...
const ChalanReport = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const response = await axios.get(`https://api.ashrafulenterprise.com/chalans-report`, { params });
    ...
    const handleDelete = async (item) => {
        ...
        if (isConfirmed) {
            try {
                const response = await axios.delete(`https://api.ashrafulenterprise.com/delete-chalan/${itemId}`);
    ...
    const downloadPDF = () => {
        ...
        doc.text("M/S Fatema Naz Petrolium", 105, 15, { align: "center" });
