...
const ShortCalculationSahena = () => {
    const navigate = useNavigate();

    const { register, control, handleSubmit, watch, reset } = useForm({
        defaultValues: {
            sheetTitle: "Shahana Enterprise Short Calculation",
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await fetch('https://api.ashrafulenterprise.com/save-short-calculations-sahena', {
                method: 'POST',
...
export default ShortCalculationSahena;