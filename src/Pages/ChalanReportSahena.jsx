...
const ChalanReportSahena = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const response = await axios.get(`https://api.ashrafulenterprise.com/chalans-report-sahena`, { params });
    ...
    const handleDelete = async (item) => {
        ...
        if (isConfirmed) {
            try {
                const response = await axios.delete(`https://api.ashrafulenterprise.com/delete-chalan-sahena/${itemId}`);
...
export default ChalanReportSahena;