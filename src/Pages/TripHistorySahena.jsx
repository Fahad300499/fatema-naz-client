...
const TripHistorySahena = () => {
    ...
    const downloadPDF = () => {
        ...
        doc.text("Imam Hossain Petroleum - Trip Report", 40, 40);
        autoTable(doc, { 
            html: '#trip-table',
            startY: 60,
            theme: 'grid',
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 mb-8 no-print">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                        {[
                            { name: "জরিমানা", path: "/fine-report-sahena", color: "hover:bg-red-50 text-red-600 border-red-200" },
                            { name: "জামানত", path: "/security-report-sahena", color: "hover:bg-purple-50 text-purple-600 border-purple-200" },
                            { name: "এক্সট্রা জরিমানা", path: "/extra-fine-report-sahena", color: "hover:bg-orange-50 text-orange-600 border-orange-200" },
                            { name: "ডিজেল", path: "/diesel-report-sahena", color: "hover:bg-blue-50 text-blue-600 border-blue-200" },
                            { name: "২য় পাওনা", path: "/second-payment-report-sahena", color: "hover:bg-teal-50 text-teal-600 border-teal-200" },
                        ].map((item) => (
                            <button 
                                key={item.name} 
