...
const FineReportImam = () => {
    ...
    // সব ট্রিপ থেকে জরিমানাযুক্ত রো গুলো ফিল্টার করা
    ...
    const downloadPDF = () => {
        ...
        doc.text("Fatema Naz Petroleum - Fine Report (Imam)", 40, 40);
        ...
        doc.save(`Fine_Report_Imam_${new Date().getTime()}.pdf`);
    };
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-8 no-print">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-3xl font-extrabold text-red-700">জরিমানা রিপোর্ট (ইমাম)</h1>
                    </div>
                </div>
