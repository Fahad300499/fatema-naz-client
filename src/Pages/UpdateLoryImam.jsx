...
const UpdateLoryImam = () => {
    ...
    useEffect(() => {
        const fetchCurrentData = async () => {
            try {
                const res = await axios.get(`https://fatema-naz-server-6.onrender.com/lory-details-imam/${id}`);
                if (res.data) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.put(`https://fatema-naz-server-6.onrender.com/edit-lory-imam/${id}`, formData);
