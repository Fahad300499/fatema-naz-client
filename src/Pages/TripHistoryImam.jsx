...
const TripHistoryImam = () => {
    ...
    try {
        ...
        await axios.delete(`https://api.ashrafulenterprise.com/trips-imam/${targetRow.parentTripId}/row/${targetId}`);
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 mb-8 no-print">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        {[
                            { name: "Fine", path: "/fine-report-imam", color: "hover:bg-red-50 text-red-600 border-red-200" },
                            { name: "Security", path: "/security-report-imam", color: "hover:bg-purple-50 text-purple-600 border-purple-200" },
                            { name: "Extra Fine", path: "/extra-fine-report-imam", color: "hover:bg-orange-50 text-orange-600 border-orange-200" },
                            { name: "Diesel", path: "/diesel-report-imam", color: "hover:bg-blue-50 text-blue-600 border-blue-200" },
