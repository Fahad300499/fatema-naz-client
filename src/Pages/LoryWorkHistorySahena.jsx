...
const LoryWorkHistorySahena = () => {
    ...
    const fetchAllHistory = async () => {
        setLoading(true);
        try {
            const response = await fetch('https://api.ashrafulenterprise.com/trips/all-lory-works-sahena'); 
  ...
  const handleRowClick = async (id) => {
    ...
    if (confirmDelete) {
        try {
            const response = await fetch(`https://api.ashrafulenterprise.com/trips/delete-lory-work-sahena/${id}`, {
                method: 'DELETE',
            });
