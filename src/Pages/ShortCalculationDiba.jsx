...
const ShortCalculationDiba = () => {
    const navigate = useNavigate();

    const { register, control, handleSubmit, watch, reset } = useForm({
        defaultValues: {
            sheetTitle: "Diba Ratri Short Calculation",
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await fetch('https://api.ashrafulenterprise.com/save-short-calculations-diba', {
                method: 'POST',
...
export default ShortCalculationDiba;