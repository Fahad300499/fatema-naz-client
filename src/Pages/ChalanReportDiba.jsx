...
const ChalanReportDiba = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            ...
            const response = await axios.get(`https://api.ashrafulenterprise.com/chalans-report-diba`, { params });
    ...
    const handleDelete = async (item) => {
        ...
        if (isConfirmed) {
            try {
                const response = await axios.delete(`https://api.ashrafulenterprise.com/delete-chalan-diba/${itemId}`);
    ...
    const downloadPDF = () => {
        ...
        doc.text("M/S Diba Ratri Filling Station", 105, 15, { align: "center" });
...
export default ChalanReportDiba;