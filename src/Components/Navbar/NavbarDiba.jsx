  ...
  return (
    <nav className="max-w-7xl mx-auto px-4 mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
        ...
        <Link to="/per-trip-cost-diba" className="w-full">
        ...
        {isAdmin && (
          <Link to="/trip-history-diba" className="w-full">
            <div className={`group relative p-6 rounded-3xl transition-all duration-300 border-2 overflow-hidden h-full
        ...
        {isAdmin && (
          <Link to="/diba-total-lory" className="w-full">
            <div className={`group relative p-6 rounded-3xl transition-all duration-300 border-2 overflow-hidden h-full
              ${isActive('/fatema-total-lory') ? 'border-green-600 bg-green-50 shadow-xl scale-105' : 'border-gray-200 bg-white hover:border-green-200 hover:shadow-2xl hover:-translate-y-1'}`}>
               ...
               <div className="flex flex-col items-center text-center relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-gray-800 leading-tight">Total Lory Of <br /> Diba Ratri</h3>
               </div>
            </div>
          </Link>
        )}
        ...
        {/* কার্ড ৪: Dip Chalan */}
        <Link to="/dip-chalan-diba" className="w-full">
          <div className={`group relative p-6 rounded-3xl transition-all duration-300 border-2 overflow-hidden h-full
        ...
        {isAdmin && (
          <Link to="/chalan-report-diba" className="w-full">
            <div className={`group relative p-6 rounded-3xl transition-all duration-300 border-2 overflow-hidden h-full
        ...
        {/* কার্ড ৬: Lory Work */}
        <Link to="/lory-work-diba" className="w-full">
          <div className={`group relative p-6 rounded-3xl transition-all duration-300 border-2 overflow-hidden h-full
        ...
        {isAdmin && (
          <Link to="/lory-work-history-diba" className="w-full">
            <div className={`group relative p-6 rounded-3xl transition-all duration-300 border-2 overflow-hidden h-full
