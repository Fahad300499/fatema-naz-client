...
const FatemaNaz = () => {
    ...
    // AuthContext থেকে সরাসরি user এবং dbUser (যেখানে রোল আছে) নেওয়া হচ্ছে
    const { user, dbUser, logOut } = useContext(AuthContext);

    // আগের সেই useEffect (fetch role) ডিলিট করে দেওয়া হয়েছে কারণ রোল এখন dbUser-এ আছে
    ...
    return (
        <div className="min-h-screen bg-[#f1f5f9]">
                    ...
                    <div className="flex justify-between items-center h-20">
                        ...
                        <div className="flex items-center gap-4">
                            {user ? (
                                <div className="flex items-center gap-3 bg-white p-1.5 rounded-2xl shadow-sm border border-slate-100 pr-5">
                                    ...
                                    <div className="hidden md:block">
                                        ...
                                        <p className="text-[10px] text-primary font-black uppercase tracking-widest mt-1">
                                            {/* dbUser থেকে রোল চেক করা হচ্ছে */}
                                            {dbUser?.role === 'admin' ? 'Administrator' : 'General Staff'}
                                        </p>
                                    </div>
                                ...
                                <button onClick={() => navigate('/login')} className="btn btn-primary btn-md rounded-2xl px-8 shadow-lg shadow-primary/30">লগইন</button>
                            )}
                        </div>
                    </div>
                </div>
            ...
            <div className="relative h-[500px] md:h-[650px] w-full flex items-center justify-center overflow-hidden">
                <div 
                    className="absolute inset-0 bg-cover bg-center bg-no-repeat transition-transform duration-[10s] transform scale-110 hover:scale-100"
                    style={{ 
                        backgroundImage: `url('https://passengervoice.net/uploads/media_image/2025/10/oil-5e2d039c2636f.jpg')`,
                    }}
                >
                ...
                <div className="relative z-10 w-full max-w-7xl px-6 flex flex-col items-start md:items-center text-left md:text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl">
                        ...
                        <span className="text-white text-[11px] font-black tracking-[0.2em] uppercase">SYSTEM ONLINE</span>
                    </div>

                    <div className="space-y-4">
                        <h1 className="text-5xl md:text-8xl font-black tracking-tight leading-tight">
                            <span className="text-white">ম্যানেজমেন্ট  </span>
                            <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary via-blue-400 to-primary animate-gradient-x italic drop-shadow-sm">
                                  ড্যাশবোর্ড
                            </span>
                        </h1>
            ...
            <div className="max-w-7xl mx-auto px-6 -mt-32 relative z-20 pb-32">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div
                        ...
                        className="group relative bg-white rounded-[3rem] p-1.5 shadow-2xl hover:shadow-primary/30 transition-all duration-500 cursor-pointer overflow-hidden border border-white"
                    >
                        <div className="bg-slate-50 rounded-[2.8rem] p-10 flex flex-col items-center">
                            ...
                            <h2 className="text-3xl font-black text-slate-800 mb-4">ফাতেমা নাজ পেট্রোলিয়াম</h2>
                    ...
                    >
                        <div className="bg-slate-50 rounded-[2.8rem] p-10 flex flex-col items-center">
                            ...
                            <h2 className="text-3xl font-black text-slate-800 mb-4">ইমাম হোসেন পেট্রোলিয়াম</h2>
            ...
            <footer className="py-12 bg-slate-900 text-slate-500">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <p className="text-xs font-bold tracking-[0.3em] uppercase">© 2026 FN Petroleum Group</p>
                </div>
            </footer>
        </div>
    );
